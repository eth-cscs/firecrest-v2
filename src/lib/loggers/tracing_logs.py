...
tracing_log_enable = contextvars.ContextVar("tracing_log_enable", default=False)
...
def init_tracing_log(enable_log: bool):
    tracing_log_enable.set(enable_log)


def tracing_log_method(func):
    @wraps(func)
    def wrapper(*args, **kwargs):
        if tracing_log_enable.get():
            func(*args, **kwargs)
        else:
            return
    return wrapper
