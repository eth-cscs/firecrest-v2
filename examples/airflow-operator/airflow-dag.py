...
workdir = '/path/to/demo/dir'                   # directory on local computer
remotedir = '/home/fireuser/airflow-example'    # directory on remote HPC system
username = 'username'                           # username
system = 'eiger'                                # HPC system name
