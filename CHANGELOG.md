...
- ***⚠️ API Breaking*** `GET /compute/{system_name}/jobs` now defaults to a `24h` historical lookback window instead of the previous fixed 7 days. Pass `time_window=7d` to restore the old behavior.
